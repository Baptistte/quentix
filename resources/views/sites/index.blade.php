...
<head>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      /* Quand active, la sidebar se glisse */
      .sidebar.active {
...
<body>
  ...
  <button class="burger" id="burgerMenu" aria-label="Ouvrir le menu">
    <span></span>
    <span></span>
    <span></span>
  </button>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg flex flex-col justify-between relative w-full">
        ...
        <div class="mt-6 flex space-x-3">
          <a class="px-4 py-2 text-sm font-semibold text-white bg-purple-600 rounded-lg hover:bg-purple-700 transition">
            ⚙️ Gérer
          </a>
          <form method="POST">
            @csrf
