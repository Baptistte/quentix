...
<body class="flex flex-col">
    ...
    <main class="hero-bg flex-grow">
        ...
        <section class="py-20 my-[130px]">
            <div class="container mx-auto px-6 text-center">
                ...
                <p class="text-lg text-white mb-6">
                    Vous créer une identité numérique <br> est accessible à tout le monde grace à Quentix
                </p>
                @auth
        ...
        <!-- Comment ça marche (Format paysage, cartes inclinées) -->
        ...
        <!-- Tutoriel rapide avec un style violet et moderne -->
