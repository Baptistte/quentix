...
<body>
    ...
    <div class="relative bg-white w-full flex justify-center" id="maincontainer">
        ...
        <div class="w-full md:w-1/4 flex flex-col justify-center px-6">
            ...
            <form action="{{ route('register.post') }}" method="POST" class="w-full max-w-sm mx-auto text-center">
                @csrf
            
                <!-- Nom & Prénom (sur la même ligne) -->
                <div class="mb-4 flex space-x-4">
                    <input type="text" id="first_name" name="first_name" required
                        class="w-1/2 px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-600 focus:outline-none text-lg"
                        placeholder="Nom">
